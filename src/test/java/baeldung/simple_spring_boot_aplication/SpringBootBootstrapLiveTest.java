...
public class SpringBootBootstrapLiveTest {
    ...
    private String createBookAsUri(Book book) {
        ...
        assertEquals(HttpStatus.CREATED.value(), response.getStatusCode(), "Book creation failed");
    ...
    public void whenGetBooksByTitle_thenOK() {
        ...
        assertTrue(books.size() > 0, "No books returned for given title");
    }
    ...
    public void whenInvalidBook_thenError() {
        Book book = createRandomBook();
        book.setAuthor(null); // Invalid because author is null
    ...
    public void whenUpdateCreatedBook_thenUpdated() {
        ...
        // Extract ID from URI and update author
        ...
        // Retrieve and assert updated author
